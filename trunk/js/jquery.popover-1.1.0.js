...
;(function($) {
	...
	var _ = {
		...
		pop_position_class: function(popover, position) {
			...
			var big_arrow = "big-top-arrow";
			var big_arrow_remove = "big-right-arrow big-bottom-arrow big-left-arrow";
			
			if(position == 'top') {
				remove = "popover-right popover-bottom popover-left";
				arrow = 'bottom-arrow';
				arrow_remove = "top-arrow right-arrow left-arrow";
				big_arrow = 'big-bottom-arrow';
				big_arrow_remove = "big-top-arrow big-right-arrow big-left-arrow";
			} else if(position == 'right') {
				remove = "popover-yop popover-bottom popover-left";
				arrow = 'left-arrow';
				arrow_remove = "top-arrow right-arrow bottom-arrow";
				big_arrow = 'big-left-arrow';
				big_arrow_remove = "big-top-arrow big-right-arrow big-bottom-arrow";
			} else if(position == 'left') {
				remove = "popover-top popover-right popover-bottom";
				arrow = 'right-arrow';
				arrow_remove = "top-arrow bottom-arrow left-arrow";
				big_arrow = 'big-right-arrow';
				big_arrow_remove = "big-top-arrow big-bottom-arrow big-left-arrow";
			}
	...
	var methods = {
		 ...
		 * @return jQuery
		 */
		content: function(html, engineFlag) {
			return this.each(function() {
				var $this = $(this);
				var data = $this.popover('getData');
				var lHtml = html;
				...
				if(data) {
					if (engineFlag && $this.data('content')) {
						lHtml = Mustache.to_html(html, $this.data('content'));
					}
		...
		setClasses: function(className) {
			return this.each(function() {
				...
				if(data) {
					data.popover.addClass(className);
				}
			});
		},
