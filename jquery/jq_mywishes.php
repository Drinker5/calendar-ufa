              ...
              if ($myWishes[$i]['akcia_id'] == 0){
                $html .= "<div id=\"wish".$myWishes[$i]['akcia_id']."\" class=\"wish-item group toggle-stop\">
                            ...
                            <div class=\"wish-content wrapped\">
                                <strong>wishlist</strong><a href=\"/gift-".$myWishes[$i]['akcia_id']."\" class=\"wish-target\"><strong>".$myWishes[$i]['wlist_name']."</strong></a><span class=\"date\">".ShowDateRus($myWishes[$i]['adddata'])."</span>
                                <p>
                                    <!--
